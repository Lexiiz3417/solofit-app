<script lang="ts">
	...
	// Import Dialog yang kita butuhkan
	...
	let isDialogOpen = $state(false); // <-- 1. State buat ngontrol dialognya (ini kuncinya)
	...
	// Fungsi ini akan dieksekusi oleh tombol konfirmasi di dalam dialog
...
<main class="flex items-center justify-center min-h-screen bg-gray-100 py-12">
	<div class="w-full max-w-lg p-8 space-y-8 bg-white rounded-lg shadow-md">
		...
		<div class="space-y-6">
			...
			<div>
				<label for="commitment" class="block text-sm font-medium text-gray-700"
	...
	<Dialog bind:open={isDialogOpen}>
		<DialogContent>
			<DialogHeader>
				<DialogTitle class="text-center">[ PERINGATAN SISTEM ]</DialogTitle>
